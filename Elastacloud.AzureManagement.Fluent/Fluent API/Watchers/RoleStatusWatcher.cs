...
namespace Elastacloud.AzureManagement.Fluent.Watchers
{
    ...
    /// </summary>
    /// <param name="status">The RoleStatus depicting the change</param>
    public delegate void StatusChange(RoleStatus newStatus, RoleStatus oldStatus);

    /// <summary>
    /// The watcher class used to monitor whether a role has had a status change
    /// </summary>
    public class RoleStatusWatcher : BaseWatcher
    {
        /// <summary>
        ...
        /// </summary>
        public RoleStatus CurrentState { get; private set; }
        ...
        {
            var command = new GetRoleStatusCommand(HostedServiceName, RoleName, ProductionOrStaging)
                              {
                                  SubscriptionId = SubscriptionId,
                                  Certificate = ManagementCertificate
                              };
            command.Execute();
            RoleStatus status = command.RoleStatus;
