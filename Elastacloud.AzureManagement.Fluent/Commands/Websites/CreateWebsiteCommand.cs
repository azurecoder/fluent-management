    ...
    internal class CreateWebsiteCommand : ServiceCommand
    {
        ...
        protected override string CreatePayload()
        {
            ...
            var doc = new XDocument(
                    ...
                    new XElement(xmlns + "Site", new XAttribute("xmlns" + "i", "http://www.w3.org/2001/XMLSchema-instance"),
                            new XElement(xmlns + "AdminEnabled", new XAttribute("i" + "nil", "true")),
                            new XElement(xmlns + "AvailabilityState", Website.WebsiteParameters.AvailabilityState),
                            new XElement(xmlns + "Enabled", new XAttribute("i" + "nil", "true")),
                            new XElement(xmlns + "EnabledHostNames", 
                                new XAttribute("i" + "nil", "true"),
                                new XAttribute("xmlns" + "a", "http://schemas.microsoft.com/2003/10/Serialization/Arrays"),
                                new XElement(xmlns + "HostNames", new XAttribute("xmlns" + "a", "http://schemas.microsoft.com/2003/10/Serialization/Arrays")),
                                    new XElement(a +"string", Website.Name + WebsitePostfix),
                                new XElement(xmlns + "Name", Website.Name),
                                new XElement(xmlns + "Owner", new XAttribute("i" + "nil", "true")),
                                new XElement(xmlns + "RepositorySiteName", new XAttribute("i" + "nil", "true")),
                                new XElement(xmlns + "SSLCertificates", new XAttribute("i" + "nil", "true")),
                                new XElement(xmlns + "SelfLink", new XAttribute("i" + "nil", "true")),
                                new XElement(xmlns + "SiteMode", new XAttribute("i" + "nil", "true")),
                                new XElement(xmlns + "SiteProperties", new XAttribute("i" + "nil", "true")),
                                new XElement(xmlns + "State", new XAttribute("i" + "nil", "true")),
                                new XElement(xmlns + "State", Website.Usage),
